...
Subjlist="LS4025 LS4036 LS4041" #Space delimited list of subject IDs
...
LevelOneTasksList="tfMRI_WM_LR@tfMRI_WM_RL" #Delimit runs with @ and tasks with space
LevelOneFSFsList="tfMRI_WM_LR@tfMRI_WM_RL" #Delimit runs with @ and tasks with space
